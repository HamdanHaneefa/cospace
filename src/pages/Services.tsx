...
const Services = () => {
  ...
  const servicesInView = useInView(servicesRef, { once: true, margin: "0px 0px -20% 0px", amount: 0.2 });
  const amenitiesInView = useInView(amenitiesRef, { once: true, margin: "0px 0px -20% 0px", amount: 0.2 });
  const ctaInView = useInView(ctaRef, { once: true, margin: "0px 0px -20% 0px", amount: 0.2 });
